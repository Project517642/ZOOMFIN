...
const FDInfo = () => {
  return (
    <>
     <div className='text-left mt-20 flex flex-col items-start lg:px-20 px-3 py-6 bg-purple-100 mx-20 rounded-xl'>
      ...
      <div className="grid grid-cols-1   gap-6">
        ...
        <div className="bg-gray-200 shadow-md rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <p className="text-gray-700">Deposit Amount</p>
              <p className="text-xl font-bold">Rs. 15,000 to Rs. 5 cr</p>
            </div>
        ...
        <button className='w-[25%] bg-green-400 hover:bg-green-500 hover:scale-95 duration-300  rounded-xl text-center text-white h-20 font-bold text-xl'>OPEN FD</button>
        </div></a>   
      </div>
    </div>
    </>
